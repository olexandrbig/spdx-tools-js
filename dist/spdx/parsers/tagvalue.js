...
exports.Parser = exports.ERROR_MESSAGES = undefined;
...
var _tagvalue = require('./lexers/tagvalue');

var _tagvalue2 = _interopRequireDefault(_tagvalue);
...
var Parser = exports.Parser = function () {
  function Parser(builder, logger) {
    _classCallCheck(this, Parser);

    this.tokens = _tagvalue2.default.tokens;
    this.builder = builder;
    this.logger = logger;
    this.error = false;
    this.license_list_parser = (0, _utils2.default)();
    this.license_list_parser.build(write_tables = 0, debug = 0);
  }

  _createClass(Parser, [{
    key: 'p_start_1',
    value: function p_start_1(p) {
      'start : start attrib ';
    ...
    key: 'more_than_one_error',
    value: function more_than_one_error(tag, line) {
      this.error = true;
      var msg = ERROR_MESSAGES['MORE_THAN_ONE'].replace('{0}', tag).replace('{1}', line);
      this.logger.log(msg);
    }
  }, {
    key: 'order_error',
    value: function order_error(first_tag, second_tag, line) {
      /*Reports an OrderError. Error message will state that
      first_tag came before second_tag.
      */
      this.error = true;
      var msg = ERROR_MESSAGES['A_BEFORE_B'].replace('{0}', first_tag).replace('{1}', second_tag).replace('{2}', line);
      this.logger.log(msg);
    }
  }, {
    key: 'p_lic_xref_1',
    value: function p_lic_xref_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_lic_xref_2',
    value: function p_lic_xref_2(p) {
      /*lic_xref : LICS_CRS_REF error*/
      this.error = true;
      var msg = ERROR_MESSAGES['LICS_CRS_REF_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_lic_comment_1',
    value: function p_lic_comment_1(p) {
    ...
    key: 'p_lic_comment_2',
    value: function p_lic_comment_2(p) {
      /*lic_comment : LICS_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['LICS_COMMENT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_extr_lic_name_1',
    value: function p_extr_lic_name_1(p) {
    ...
    key: 'p_extr_lic_name_2',
    value: function p_extr_lic_name_2(p) {
      /*extr_lic_name : LICS_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['LICS_NAME_VALE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_extr_lic_name_value_1',
    value: function p_extr_lic_name_value_1(p) {
      /*extr_lic_name_value : LINE*/
      p[0] = p[1];
    }
  }, {
    key: 'p_extr_lic_name_value_2',
    value: function p_extr_lic_name_value_2(p) {
      /*extr_lic_name_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_extr_lic_text_1',
    value: function p_extr_lic_text_1(p) {
    ...
    key: 'p_extr_lic_text_2',
    value: function p_extr_lic_text_2(p) {
      /*extr_lic_text : LICS_TEXT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['LICS_TEXT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_extr_lic_id_1',
    value: function p_extr_lic_id_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg = ERROR_MESSAGES['LICS_ID_VALUE'].format(p.lineno(1));
    ...
    key: 'p_extr_lic_id_2',
    value: function p_extr_lic_id_2(p) {
      /*extr_lic_id : LICS_ID error*/
      // @TODO: Fix this
      this.error = true;
      var msg = ERROR_MESSAGES['LICS_ID_VALUE'].replace("{0}", p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_uknown_tag',
    value: function p_uknown_tag(p) {
      /*unknown_tag : UNKNOWN_TAG LINE*/
      // @TODO: Fix this
      this.error = true;
      var msg = ERROR_MESSAGES['UNKNOWN_TAG'].replace('{0}', p[1]).replace('{1}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_artifact_1',
    value: function p_file_artifact_1(p) {
    ...
    key: 'p_file_artificat_2',
    value: function p_file_artificat_2(p) {
      /*file_artifact : prj_name_art error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_ART_OPT_ORDER'].replace('{0}', p.lineno(2));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_art_rest',
    value: function p_file_art_rest(p) {
    ...
    key: 'p_prj_uri_art_1',
    value: function p_prj_uri_art_1(p) {
      /*prj_uri_art : ART_PRJ_URI UN_KNOWN*/
      try {
        this.builder.set_file_atrificat_of_project(this.document, 'uri', utils.UnKnown());
      } catch (e) {
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_prj_uri_art_2',
    value: function p_prj_uri_art_2(p) {
    ...
    key: 'p_prj_uri_art_3',
    value: function p_prj_uri_art_3(p) {
      /*prj_uri_art : ART_PRJ_URI error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ART_PRJ_URI_VALUE'].replace('{0', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_prj_home_art_1',
    value: function p_prj_home_art_1(p) {
    ...
    key: 'p_prj_home_art_2',
    value: function p_prj_home_art_2(p) {
      /*prj_home_art : ART_PRJ_HOME UN_KNOWN*/
      try {
        this.builder.set_file_atrificat_of_project(this.document, 'home', utils.UnKnown());
      } catch (e) {
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_prj_home_art_3',
    value: function p_prj_home_art_3(p) {
      /*prj_home_art : ART_PRJ_HOME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ART_PRJ_HOME_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_prj_name_art_1',
    value: function p_prj_name_art_1(p) {
    ...
    key: 'p_prj_name_art_2',
    value: function p_prj_name_art_2(p) {
      /*prj_name_art : ART_PRJ_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ART_PRJ_NAME_VALUE'].replace('{0}', p.lineno());
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_dep_1',
    value: function p_file_dep_1(p) {
    ...
    key: 'p_file_dep_2',
    value: function p_file_dep_2(p) {
      /*file_dep : FILE_DEP error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_DEP_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_contrib_1',
    value: function p_file_contrib_1(p) {
    ...
    key: 'p_file_contrib_2',
    value: function p_file_contrib_2(p) {
      /*file_contrib : FILE_CONTRIB error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_CONTRIB_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_notice_1',
    value: function p_file_notice_1(p) {
    ...
    key: 'p_file_notice_2',
    value: function p_file_notice_2(p) {
      /*file_notice : FILE_NOTICE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_NOTICE_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_cr_text_1',
    value: function p_file_cr_text_1(p) {
    ...
    key: 'p_file_cr_text_2',
    value: function p_file_cr_text_2(p) {
      /*file_cr_text : FILE_CR_TEXT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_CR_TEXT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_cr_value_1',
    value: function p_file_cr_value_1(p) {
      /*file_cr_value : TEXT*/
      p[0] = p[1];
    }
  }, {
    key: 'p_file_cr_value_2',
    value: function p_file_cr_value_2(p) {
      /*file_cr_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_file_cr_value_3',
    value: function p_file_cr_value_3(p) {
      /*file_cr_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_file_lics_comment_1',
    value: function p_file_lics_comment_1(p) {
    ...
    key: 'p_file_lics_comment_2',
    value: function p_file_lics_comment_2(p) {
      /*file_lics_comment : FILE_LICS_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_LICS_COMMENT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_lics_info_1',
    value: function p_file_lics_info_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg2 = ERROR_MESSAGES['FILE_LICS_INFO_VALUE'].format(p.lineno(1));
          this.logger.log(_msg2);
        }
      }
    }
  }, {
    key: 'p_file_lics_info_2',
    value: function p_file_lics_info_2(p) {
      /*file_lics_info : FILE_LICS_INFO error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_LICS_INFO_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_lic_info_value_1',
    value: function p_file_lic_info_value_1(p) {
      /*file_lic_info_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_file_lic_info_value_2',
    value: function p_file_lic_info_value_2(p) {
    ...
    key: 'p_file_lic_info_value_3',
    value: function p_file_lic_info_value_3(p) {
      /*file_lic_info_value : LINE*/
      var value = p[1];
      p[0] = document.License.from_identifier(value);
    }
  }, {
    key: 'p_conc_license_1',
    value: function p_conc_license_1(p) {
      /*conc_license : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_conc_license_2',
    value: function p_conc_license_2(p) {
      /*conc_license : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_conc_license_3',
    value: function p_conc_license_3(p) {
      /*conc_license : LINE*/
      var value = p[1];
    ...
    key: 'p_file_name_1',
    value: function p_file_name_1(p) {
    ...
    key: 'p_file_name_2',
    value: function p_file_name_2(p) {
      /*file_name : FILE_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_NAME_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_spdx_id',
    value: function p_spdx_id(p) {
    ...
    key: 'p_file_comment_1',
    value: function p_file_comment_1(p) {
    ...
    key: 'p_file_comment_2',
    value: function p_file_comment_2(p) {
      /*file_comment : FILE_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_COMMENT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_type_1',
    value: function p_file_type_1(p) {
    ...
    key: 'p_file_type_2',
    value: function p_file_type_2(p) {
      /*file_type : FILE_TYPE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_TYPE_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_chksum_1',
    value: function p_file_chksum_1(p) {
    ...
    key: 'p_file_chksum_2',
    value: function p_file_chksum_2(p) {
      /*file_chksum : FILE_CHKSUM error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_CHKSUM_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_conc_1',
    value: function p_file_conc_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg3 = ERROR_MESSAGES['FILE_LICS_CONC_VALUE'].format(p.lineno(1));
          this.logger.log(_msg3);
        }
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_file_conc_2',
    value: function p_file_conc_2(p) {
      /*file_conc : FILE_LICS_CONC error*/
      this.error = true;
      var msg = ERROR_MESSAGES['FILE_LICS_CONC_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_file_type_value',
    value: function p_file_type_value(p) {
    ...
    key: 'p_pkg_desc_2',
    value: function p_pkg_desc_2(p) {
      /*pkg_desc : PKG_DESC error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_DESC_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_summary_1',
    value: function p_pkg_summary_1(p) {
    ...
    key: 'p_pkg_summary_2',
    value: function p_pkg_summary_2(p) {
      /*pkg_summary : PKG_SUM error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_SUM_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_cr_text_1',
    value: function p_pkg_cr_text_1(p) {
    ...
    key: 'p_pkg_cr_text_2',
    value: function p_pkg_cr_text_2(p) {
      /*pkg_cr_text : PKG_CPY_TEXT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_CPY_TEXT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_cr_text_value_1',
    value: function p_pkg_cr_text_value_1(p) {
      /*pkg_cr_text_value : TEXT*/
      p[0] = p[1];
    }
  }, {
    key: 'p_pkg_cr_text_value_2',
    value: function p_pkg_cr_text_value_2(p) {
      /*pkg_cr_text_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_cr_text_value_3',
    value: function p_pkg_cr_text_value_3(p) {
      /*pkg_cr_text_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_lic_comment_1',
    value: function p_pkg_lic_comment_1(p) {
    ...
    key: 'p_pkg_lic_comment_2',
    value: function p_pkg_lic_comment_2(p) {
      /*pkg_lic_comment : PKG_LICS_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_LICS_COMMENT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_lic_decl_1',
    value: function p_pkg_lic_decl_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg4 = ERROR_MESSAGES['PKG_LICS_DECL_VALUE'].format(p.lineno(1));
          this.logger.log(_msg4);
        }
      }
    }
  }, {
    key: 'p_pkg_lic_decl_2',
    value: function p_pkg_lic_decl_2(p) {
      /*pkg_lic_decl : PKG_LICS_DECL error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_LICS_DECL_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_lic_ff_1',
    value: function p_pkg_lic_ff_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg5 = ERROR_MESSAGES['PKG_LIC_FFILE_VALUE'].format(p.lineno(1));
          this.logger.log(_msg5);
        }
      }
    }
  }, {
    key: 'p_pkg_lic_ff_value_1',
    value: function p_pkg_lic_ff_value_1(p) {
      /*pkg_lic_ff_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_lic_ff_value_2',
    value: function p_pkg_lic_ff_value_2(p) {
      /*pkg_lic_ff_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_lic_ff_value_3',
    value: function p_pkg_lic_ff_value_3(p) {
    ...
    key: 'p_pkg_lic_ff_2',
    value: function p_pkg_lic_ff_2(p) {
      /*pkg_lic_ff : PKG_LICS_FFILE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_LIC_FFILE_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_lic_conc_1',
    value: function p_pkg_lic_conc_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg6 = ERROR_MESSAGES['PKG_LICS_CONC_VALUE'].format(p.lineno(1));
          this.logger.log(_msg6);
        }
      }
    }
  }, {
    key: 'p_pkg_lic_conc_2',
    value: function p_pkg_lic_conc_2(p) {
      /*pkg_lic_conc : PKG_LICS_CONC error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_LICS_CONC_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_src_info_1',
    value: function p_pkg_src_info_1(p) {
    ...
    key: 'p_pkg_src_info_2',
    value: function p_pkg_src_info_2(p) {
      /*pkg_src_info : PKG_SRC_INFO error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_SRC_INFO_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_chksum_1',
    value: function p_pkg_chksum_1(p) {
    ...
    key: 'p_pkg_chksum_2',
    value: function p_pkg_chksum_2(p) {
      /*pkg_chksum : PKG_CHKSUM error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_CHKSUM_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_verif_1',
    value: function p_pkg_verif_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg7 = ERROR_MESSAGES['PKG_VERF_CODE_VALUE'].format(p.lineno(1));
          this.logger.log(_msg7);
        }
      }
    }
  }, {
    key: 'p_pkg_verif_2',
    value: function p_pkg_verif_2(p) {
      /*pkg_verif : PKG_VERF_CODE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_VERF_CODE_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_home_1',
    value: function p_pkg_home_1(p) {
    ...
    key: 'p_pkg_home_2',
    value: function p_pkg_home_2(p) {
      /*pkg_home : PKG_HOME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_HOME_VALUE'];
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_home_value_1',
    value: function p_pkg_home_value_1(p) {
      /*pkg_home_value : LINE*/
      p[0] = p[1];
    }
  }, {
    key: 'p_pkg_home_value_2',
    value: function p_pkg_home_value_2(p) {
      /*pkg_home_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_home_value_3',
    value: function p_pkg_home_value_3(p) {
      /*pkg_home_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_down_location_1',
    value: function p_pkg_down_location_1(p) {
    ...
    key: 'p_pkg_down_location_2',
    value: function p_pkg_down_location_2(p) {
      /*pkg_down_location : PKG_DOWN error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_DOWN_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_down_value_1',
    value: function p_pkg_down_value_1(p) {
      /*pkg_down_value : LINE */
      p[0] = p[1];
    }
  }, {
    key: 'p_pkg_down_value_2',
    value: function p_pkg_down_value_2(p) {
      /*pkg_down_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_down_value_3',
    value: function p_pkg_down_value_3(p) {
      /*pkg_down_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_orig_1',
    value: function p_pkg_orig_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg8 = ERROR_MESSAGES['PKG_ORIG_VALUE'].format(p.lineno(1));
          this.logger.log(_msg8);
        }
      }
    }
  }, {
    key: 'p_pkg_orig_2',
    value: function p_pkg_orig_2(p) {
      /*pkg_orig : PKG_ORIG error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_ORIG_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_supplier_1',
    value: function p_pkg_supplier_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg9 = ERROR_MESSAGES['PKG_SUPPL_VALUE'].format(p.lineno(1));
          this.logger.log(_msg9);
        }
      }
    }
  }, {
    key: 'p_pkg_supplier_2',
    value: function p_pkg_supplier_2(p) {
      /*pkg_supplier : PKG_SUPPL error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_SUPPL_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_pkg_supplier_values_1',
    value: function p_pkg_supplier_values_1(p) {
      /*pkg_supplier_values : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_pkg_supplier_values_2',
    value: function p_pkg_supplier_values_2(p) {
      /*pkg_supplier_values : entity*/
      p[0] = p[1];
    }
  }, {
    key: 'p_pkg_file_name',
    value: function p_pkg_file_name(p) {
    ...
    key: 'p_pkg_file_name_1',
    value: function p_pkg_file_name_1(p) {
      /*pkg_file_name : PKG_FILE_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_FILE_NAME_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_package_version_1',
    value: function p_package_version_1(p) {
    ...
    key: 'p_package_version_2',
    value: function p_package_version_2(p) {
      /*package_version : PKG_VERSION error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PKG_VERSION_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_package_name',
    value: function p_package_name(p) {
    ...
    key: 'p_package_name_1',
    value: function p_package_name_1(p) {
      /*package_name : PKG_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['PACKAGE_NAME_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snip_spdx_id',
    value: function p_snip_spdx_id(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg10 = ERROR_MESSAGES['SNIP_SPDX_ID_VALUE'].format(p.lineno(2));
          this.logger.log(_msg10);
        }
      }
    }
  }, {
    key: 'p_snip_spdx_id_1',
    value: function p_snip_spdx_id_1(p) {
      /*snip_spdx_id : SNIPPET_SPDX_ID error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_SPDX_ID_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snippet_name',
    value: function p_snippet_name(p) {
    ...
    key: 'p_snippet_name_1',
    value: function p_snippet_name_1(p) {
      /*snip_name : SNIPPET_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIPPET_NAME_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snippet_comment',
    value: function p_snippet_comment(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg11 = ERROR_MESSAGES['SNIP_COMMENT_VALUE'].format(p.lineno(2));
          this.logger.log(_msg11);
        }
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_snippet_comment_1',
    value: function p_snippet_comment_1(p) {
      /*snip_comment : SNIPPET_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_COMMENT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snippet_cr_text',
    value: function p_snippet_cr_text(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg12 = ERROR_MESSAGES['SNIP_COPYRIGHT_VALUE'].format(p.lineno(2));
          this.logger.log(_msg12);
        }
      }
    }
  }, {
    key: 'p_snippet_cr_text_1',
    value: function p_snippet_cr_text_1(p) {
      /*snip_cr_text : SNIPPET_CR_TEXT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_COPYRIGHT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snippet_cr_value_1',
    value: function p_snippet_cr_value_1(p) {
      /*snip_cr_value : TEXT*/
      p[0] = p[1];
    }
  }, {
    key: 'p_snippet_cr_value_2',
    value: function p_snippet_cr_value_2(p) {
      /*snip_cr_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_snippet_cr_value_3',
    value: function p_snippet_cr_value_3(p) {
      /*snip_cr_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_snippet_lic_comment',
    value: function p_snippet_lic_comment(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg13 = ERROR_MESSAGES['SNIP_LICS_COMMENT_VALUE'].format(p.lineno(2));
          this.logger.log(_msg13);
        }
      }
    }
  }, {
    key: 'p_snippet_lic_comment_1',
    value: function p_snippet_lic_comment_1(p) {
      /*snip_lic_comment : SNIPPET_LICS_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_LICS_COMMENT_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snip_from_file_spdxid',
    value: function p_snip_from_file_spdxid(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg14 = ERROR_MESSAGES['SNIP_FILE_SPDXID_VALUE'].format(p.lineno(2));
          this.logger.log(_msg14);
        }
      }
    }
  }, {
    key: 'p_snip_from_file_spdxid_1',
    value: function p_snip_from_file_spdxid_1(p) {
      /*snip_file_spdx_id : SNIPPET_FILE_SPDXID error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_FILE_SPDXID_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snippet_concluded_license',
    value: function p_snippet_concluded_license(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.order_error('SnippetLicenseConcluded', 'SnippetSPDXID', p.lineno(1));
        }
        if (e instanceof _builderexceptions2.default) {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg15 = ERROR_MESSAGES['SNIP_LICS_CONC_VALUE'].format(p.lineno(1));
          this.logger.log(_msg15);
        }
      }
    }
  }, {
    key: 'p_snippet_concluded_license_1',
    value: function p_snippet_concluded_license_1(p) {
      /*snip_lics_conc : SNIPPET_LICS_CONC error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_LICS_CONC_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snippet_lics_info',
    value: function p_snippet_lics_info(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.order_error('LicenseInfoInSnippet', 'SnippetSPDXID', p.lineno(1));
        }
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg16 = ERROR_MESSAGES['SNIP_LICS_INFO_VALUE'].format(p.lineno(1));
          this.logger.log(_msg16);
        }
      }
    }
  }, {
    key: 'p_snippet_lics_info_1',
    value: function p_snippet_lics_info_1(p) {
      /*snip_lics_info : SNIPPET_LICS_INFO error*/
      this.error = true;
      var msg = ERROR_MESSAGES['SNIP_LICS_INFO_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_snip_lic_info_value_1',
    value: function p_snip_lic_info_value_1(p) {
      /*snip_lic_info_value : NONE*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_snip_lic_info_value_2',
    value: function p_snip_lic_info_value_2(p) {
      /*snip_lic_info_value : NO_ASSERT*/
      p[0] = (0, _utils2.default)();
    }
  }, {
    key: 'p_snip_lic_info_value_3',
    value: function p_snip_lic_info_value_3(p) {
    ...
    key: 'p_reviewer_1',
    value: function p_reviewer_1(p) {
      /*reviewer : REVIEWER entity*/
      this.builder.add_reviewer(this.document, p[2]);
    }
  }, {
    key: 'p_reviewer_2',
    value: function p_reviewer_2(p) {
      /*reviewer : REVIEWER error*/
      this.error = true;
      var msg = ERROR_MESSAGES['REVIEWER_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_review_date_1',
    value: function p_review_date_1(p) {
    ...
    key: 'p_review_date_2',
    value: function p_review_date_2(p) {
      /*review_date : REVIEW_DATE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['REVIEW_DATE_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_review_comment_1',
    value: function p_review_comment_1(p) {
    ...
    key: 'p_review_comment_2',
    value: function p_review_comment_2(p) {
      /*review_comment : REVIEW_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['REVIEW_COMMENT_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_annotator_1',
    value: function p_annotator_1(p) {
      /*annotator : ANNOTATOR entity*/
      this.builder.add_annotator(this.document, p[2]);
    }
  }, {
    key: 'p_annotator_2',
    value: function p_annotator_2(p) {
      /*annotator : ANNOTATOR error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ANNOTATOR_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_annotation_date_1',
    value: function p_annotation_date_1(p) {
    ...
    key: 'p_annotation_date_2',
    value: function p_annotation_date_2(p) {
      /*annotation_date : ANNOTATION_DATE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ANNOTATION_DATE_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_annotation_comment_1',
    value: function p_annotation_comment_1(p) {
    ...
    key: 'p_annotation_comment_2',
    value: function p_annotation_comment_2(p) {
      /*annotation_comment : ANNOTATION_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ANNOTATION_COMMENT_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_annotation_type_1',
    value: function p_annotation_type_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg17 = ERROR_MESSAGES['ANNOTATION_TYPE_VALUE'].format(p.lineno(1));
          this.logger.log(_msg17);
        }
      }
    }
  }, {
    key: 'p_annotation_type_2',
    value: function p_annotation_type_2(p) {
      /*annotation_type : ANNOTATION_TYPE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ANNOTATION_TYPE_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_annotation_spdx_id_1',
    value: function p_annotation_spdx_id_1(p) {
    ...
    key: 'p_annotation_spdx_id_2',
    value: function p_annotation_spdx_id_2(p) {
      /*annotation_spdx_id : ANNOTATION_SPDX_ID error*/
      this.error = true;
      var msg = ERROR_MESSAGES['ANNOTATION_SPDX_ID_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_lics_list_ver_1',
    value: function p_lics_list_ver_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg18 = ERROR_MESSAGES['LIC_LIST_VER_VALUE'].format(p[2], p.lineno(2));
          this.logger.log(_msg18);
        }
      }
    }
  }, {
    key: 'p_lics_list_ver_2',
    value: function p_lics_list_ver_2(p) {
      /*locs_list_ver : LIC_LIST_VER error*/
      this.error = true;
      var msg = ERROR_MESSAGES['LIC_LIST_VER_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_doc_comment_1',
    value: function p_doc_comment_1(p) {
    ...
    key: 'p_doc_comment_2',
    value: function p_doc_comment_2(p) {
      /*doc_comment : DOC_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['DOC_COMMENT_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_doc_namespace_1',
    value: function p_doc_namespace_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg19 = ERROR_MESSAGES['DOC_NAMESPACE_VALUE'].format(p[2], p.lineno(2));
          this.logger.log(_msg19);
        }
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_doc_namespace_2',
    value: function p_doc_namespace_2(p) {
      /*doc_namespace : DOC_NAMESPACE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['DOC_NAMESPACE_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_data_license_1',
    value: function p_data_license_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg20 = ERROR_MESSAGES['DOC_LICENSE_VALUE'].format(p[2], p.lineno(2));
          this.logger.log(_msg20);
        }
        if (e instanceof _builderexceptions2.default) {
    ...
    key: 'p_data_license_2',
    value: function p_data_license_2(p) {
      /*data_lics : DOC_LICENSE error*/
      this.error = true;
      var msg = ERROR_MESSAGES['DOC_LICENSE_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_doc_name_1',
    value: function p_doc_name_1(p) {
    ...
    key: 'p_doc_name_2',
    value: function p_doc_name_2(p) {
      /*doc_name : DOC_NAME error*/
      this.error = true;
      var msg = ERROR_MESSAGES['DOC_NAME_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_ext_doc_refs_1',
    value: function p_ext_doc_refs_1(p) {
      /*ext_doc_ref : EXT_DOC_REF DOC_REF_ID DOC_URI EXT_DOC_REF_CHKSUM*/
      try {
        var doc_ref_id = p[2];
        var doc_uri = p[3];
        var ext_doc_chksum = p[4];
        this.builder.add_ext_doc_refs(this.document, doc_ref_id, doc_uri, ext_doc_chksum);
      } catch (e) {
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg21 = ERROR_MESSAGES['EXT_DOC_REF_VALUE'].format(p.lineno(2));
          this.logger.log(_msg21);
        }
      }
    }
  }, {
    key: 'p_ext_doc_refs_2',
    value: function p_ext_doc_refs_2(p) {
      /*ext_doc_ref : EXT_DOC_REF error*/
      this.error = true;
      var msg = ERROR_MESSAGES['EXT_DOC_REF_VALUE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_spdx_version_1',
    value: function p_spdx_version_1(p) {
      ...
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          this.error = true;
          var _msg22 = ERROR_MESSAGES['DOC_VERSION_VALUE'].format(p[2], p.lineno(1));
          this.logger.log(_msg22);
        }
      }
    }
  }, {
    key: 'p_spdx_version_2',
    value: function p_spdx_version_2(p) {
      /*spdx_version : DOC_VERSION error*/
      this.error = true;
      var msg = ERROR_MESSAGES['DOC_VERSION_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_creator_comment_1',
    value: function p_creator_comment_1(p) {
    ...
    key: 'p_creator_comment_2',
    value: function p_creator_comment_2(p) {
      /*creator_comment : CREATOR_COMMENT error*/
      this.error = true;
      var msg = ERROR_MESSAGES['CREATOR_COMMENT_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_creator_1',
    value: function p_creator_1(p) {
      /*creator : CREATOR entity*/
      this.builder.add_creator(this.document, p[2]);
    }
  }, {
    key: 'p_creator_2',
    value: function p_creator_2(p) {
      /*creator : CREATOR error*/
      this.error = true;
      var msg = ERROR_MESSAGES['CREATOR_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_created_1',
    value: function p_created_1(p) {
    ...
    key: 'p_created_2',
    value: function p_created_2(p) {
      /*created : CREATED error*/
      this.error = true;
      var msg = ERROR_MESSAGES['CREATED_VALUE_TYPE'].replace('{0}', p.lineno(1));
      this.logger.log(msg);
    }
  }, {
    key: 'p_entity_1',
    value: function p_entity_1(p) {
      /*entity : TOOL_VALUE
      */
      try {
        var value = p[1];
    ...
    value: function p_entity_2(p) {
      ...
      */
      try {
        ...
        if (e instanceof _builderexceptions2.default) {
          var _msg23 = ERROR_MESSAGES['ORG_VALUE'].format(p[1], p.lineno(1));
          this.logger.log(_msg23);
          this.error = true;
          p[0] = None;
        }
      }
